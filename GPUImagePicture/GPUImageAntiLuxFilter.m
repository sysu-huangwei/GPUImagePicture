...
NSString *const kGPUImageAntiLuxFragmentShaderString = SHADER_STRING
(
...
@interface GPUImageAntiLuxFilter()
...
@implementation GPUImageAntiLuxFilter

- (instancetype) initWithCDFPath:(NSString *) path {
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageAntiLuxFragmentShaderString]))
    {
        return nil;
    }
